...
Fullstack & DevOps developer, passionate about building products end-to-end.  
Currently based in France, I enjoy working on scalable web apps, mobile projects, and experimenting with DevOps tooling.  

---

## 🧑 About me
- 🎓 Background in computer science & software engineering  
- 💻 Building apps from backend to frontend, with a touch of DevOps  
- 🌍 Interested in tech, running, and traveling

---

## 🚀 Featured Projects
- [**Bibliocards**](https://bibliocards.com) – An app to collect, organize, and share K-POP photocards (iOS & Android)
- [**ReviewInbox**](https://reviewinbox.app) - An [open-source](https://github.com/bibliocards/reviewinbox) and self-hostable AI inbox for App Store and Google Play reviews
...
![Astro](https://img.shields.io/badge/Astro-800490?style=flat&logo=astro&logoColor=white)
